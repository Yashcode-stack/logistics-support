...
export class PartnerLocationsController {
  constructor(private readonly partnerLocationsService: PartnerLocationsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePartnerLocationDto: UpdatePartnerLocationDto) {
